<template>
    <p v-if="user.info.status === -1 && userQuota?.idServerPhone.length === 0 && gameList[0]?.status.created_at != 0">
    ...
    <p v-if="!isQueryWxPusher && !wxPusher">博士！！！你怎么还没有<b class="cursor-pointer"
