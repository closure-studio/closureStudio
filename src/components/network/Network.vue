        ...
        <div>
            <div class="w-full mb-3">
                <label class="label">
                    ...
                    <div class="cursor-pointer flex flex-row items-center gap-2"
                        ...
                        <input type="radio" :disabled="isAPIClientRadioDisabled"
...
const cloudflareButtonClass = computed(() => {
    ...
    if (isNaN(time) || cloudflareRadioBtnText.value === '失败') return 'btn btn-outline btn-xs btn-error';
    return time < 1 ? 'btn btn-outline btn-xs btn-success' : 'btn btn-outline btn-xs btn-warning';
});
