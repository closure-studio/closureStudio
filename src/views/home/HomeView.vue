  ...
  <div class="flex flex-col lg:flex-row pt-6 lg:pt-12 px-2 lg:px-10w h-full">
    <div class="flex flex-col justify-center items-start slide-in-bottom">
      ...
      <div class="text-6xl font-extrabold md:text-7xl flex duration-200">
        最
        <div
          class="avatar slide-in-left delay-200 absolute duration-1000"
      ...
      <div class="flex flex-wrap gap-4 slide-in-bottom delay-75 w-full">
        <a href="https://jq.qq.com/?_wv=1027&k=FiJjOEe8" class="btn btn-info flex-grow btn-outline"
          >官方 Q1 群（人满）</a
        >
        <a
          href="https://jq.qq.com/?_wv=1027&k=8C3DZiQM"
          class="btn btn-info w-1/2 md:w-1/3 hover:bg-base-100 hover:text-info"
          >官方 Q2 群</a
        >
        <a href="/dashboard" class="btn btn-info flex-grow hover:bg-base-100 hover:text-info"
          >[筹备中] 官方 Q 频</a
        >
      </div>
    </div>
    <div class="flex flex-col slide-in-bottom delay-75 lg:ml-6 flex-auto">
      <div class="lg:space-x-2 hidden lg:flex">
        <div
          class="mockup-code bg-base-300 text-base-content shadow-lg rounded-lg sm:w-full lg:w-1/2"
        >
      ...
      <div class="flex-auto grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
        <div v-for="k in list">
          ...
          <div
            class="w-full items-center flex flex-col border px-2 border-info pt-5 rounded-b-md s-pro"
          >
            <div class="indicator avatar">
              ...
              <span
                class="indicator-item indicator-bottom badge badge-info g-glossy text-lg font-en"
              >
                Lv{{ k.level }}
              </span>
            </div>
...
import Login from "@/components/home/auth/LoginDialog.vue";
